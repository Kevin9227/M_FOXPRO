...
** Data da Criação: 31-07-2023
** Tecla para Criar Ficheiro XML

Local ldir,xNomeFile,Xfile,lcXML
m.ldir = Getdir("C:\","Escolher uma Directoria","Directoria(s)",0,.F.)
If Empty(m.ldir)
	mensagem("Desculpe, não foi escolhida nenhuma directoria")
Else
	Select '' As ref,'MONDEGO - COMÉRCIO INTERNACIONAL, LDA ' As Design,3 As qtt,'Un' As Unidade,0 As pvuni,0 iva,0 as tabiva From Ft Union All ;
